...
class TimController extends Controller
{
    ...
    public function detail (Request $request, $id){
        ...
        return view('pages.admin.tim.detail', compact('agent', 'total_penjualan_pribadi_bulan', 'reseller', 'total_penjualan_pribadi_tahun', 'total_penjualan_tim_tahun', 'total_penjualan_tim_bulan', 'bonus_bulan'));
    }
    ...
    public function detailSelling(Request $request, $id){
        ...
        return view('pages.admin.tim.detail-selling', compact('agent','selling', 'bonus'));
    }
